...
$companies = array (
  array(
    ...
    'yubin' => '541-0042',
    'address' => '大阪市中央区今橋4-1-1<br>淀屋橋三井ビルディング4階',
    // 'yubin' => '541-0041',
    ...
    'contents' => array (
      ...
      array (
        ...
        'link-caption_en' => 'Official Website',
         ...
         array (
        'class' => '__sp __left',
        'filename' => 'img-business-brand-03.png',
        'alt' => 'Keds',
        'title' => 'Keds',
        'ex' => 'Keds は 1916 年の誕生以来、100 年以上にわたり時代を超えて愛される快適なスニーカーを提供してきたブランドです。象徴的な「Keds Champion」をはじめ、多様性・快適さ・スタイルを兼ね備えたデザインで、誰もが自分らしく一歩を踏み出せるシューズを展開しています。 ',
        'ex_en' => 'Keds has been providing comfortable sneakers loved across generations for more than 100 years since its debut in 1916. From the iconic “Keds Champion” to a wide range of designs that combine diversity, comfort, and style, the brand continues to offer shoes that empower everyone to take their own steps forward.',
        'link' => 'https://keds.co.jp/',
        'link-caption' => '公式ホームページへ',
        'link-caption_en' => 'Official Website',
      ),
...
$business_history = array (
  ...
  array (
    'year_jp' => '2025年',
    'year_en' => '2025',
    'ex_jp' => 'スニーカーブランド「Keds」<br>のライセンス契約締結 ',
    'ex_en' => 'Contracted an exclusive distributor agreement with sneaker brand ”Keds”',
  ),
);
