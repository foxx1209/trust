        ...
        <div class="__body">
          ...
          <div id="__03" class="__company">
            ...
            <dl class="c-dl__01">
              ...
              <dd class="c-lang-wrap __long">
                <span class="__jp">シューズメーカー事業<br>ブランドマーケティング事業<br>トレーディング事業</span>
                <span class="__en">MANUFACTURING<br>BRAND MARKETING<br>TRADING</span>
              </dd>
              <dt class="c-lang-wrap">
                <span class="__jp">関連会社</span>
                <span class="__en">Associated Company</span>
              </td>
              <dd class="c-lang-wrap __link">
                <span class="__jp">
                  <span class="__title">BMS株式会社</span>
                  <a class="c-btn__02 __lang" href="https://berwickjapan.co.jp/" target="_blank"><span>&nbsp;&nbsp;Berwick事業部</span></a>
                  <a class="c-btn__02 __lang" href="https://prokeds.jp/" target="_blank"><span>&nbsp;&nbsp;PRO-Keds事業部</span></a>
                </span>
                <span class="__en">
                  <span class="__title">BMS Co., Ltd.</span>
              ...
              <dd class="c-lang-wrap">
                <span class="__jp">グループ計50名（2024年2月時点）</span>
                <span class="__en">Group Total 50（February, 2024）</span>
              </dd>
            </dl>
          </div>
