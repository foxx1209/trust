...
// $to = "recruit@skyjapan-corp.co.jp";


//自動返信メールの送信元メールアドレス
//必ず実在するメールアドレスでかつ出来る限り設置先サイトのドメインと同じドメインのメールアドレスとすることを強く推奨します
$from = "recruit@skyjapan-corp.co.jp";
...
$require = array('応募職種','名前','フリガナ','生年月日年','生年月日月','生年月日日','メールアドレス','電話番号','個人情報の取り扱い規定');
...
<link rel="stylesheet" href="<?php echo $parent.'css/'.$entry['link'].'.css?'.$version; ?>">
...
<!-- ▼************ 送信内容表示部　※編集は自己責任で ************ ▼-->
<main id="<?php echo $entry['link'] ?>" class="p-contact">

	<div class="container__inner">

		<div class="__head">
			<h2 class="c-ttl__subpage__02 en"><?php echo $entry['title_jp'] ?></h2>
			<p class="c-description__31"><?php echo $entry['description'] ?></p>
		</div>
			...
			<div id="formWrap">
				...
				<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
					...
					<dl class="p-form">
						...
						<dd><?php echo $_POST['応募職種']; ?></dd>
						<dt><span class="__hissu">名前</span></dt>
						<dd><?php echo $_POST['名前']; ?></dd>
						<dt><span class="__hissu">フリガナ</span></dt>
						<dd><?php echo $_POST['フリガナ']; ?></dd>
						<dt><span class="__hissu">生年月日</span></dt>
						<dd>
							<?php echo $_POST['生年月日年']; ?><span>年</span>
							<?php echo $_POST['生年月日月']; ?><span>月</span>
							<?php echo $_POST['生年月日日']; ?><span>日</span>
						</dd>
						<dt><span class="__hissu">メールアドレス</span></dt>
						<dd><?php echo $_POST['メールアドレス']; ?></dd>
						<dt><span class="__hissu">電話番号</span></dt>
						<dd><?php echo $_POST['電話番号']; ?></dd>
						<dt><span class="__nini">備考欄</span></dt>
						<dd><?php echo $_POST['備考欄']; ?></dd>
					</dl>
					...
					<p class="__question">入力された内容で送信しますか？</p>
					<div class="__send">
						<p align="center">
